    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HelperCodes", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ParentPlacePlaceId = table.Column<Guid>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Places", x => x.PlaceId);
                    table.ForeignKey(
                        name: "FK_Places_Places_ParentPlacePlaceId",
                        column: x => x.ParentPlacePlaceId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PasssportId = table.Column<string>(nullable: true),
                    PasssportExpiryDate = table.Column<DateTime>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TourType = table.Column<string>(nullable: true),
                    Description = table.Column<string>(nullable: true),
                    Notes = table.Column<string>(nullable: true),
                    TourDuration = table.Column<int>(nullable: false),
                    IsActive = table.Column<bool>(nullable: false),
                    StartPlacePlaceId = table.Column<Guid>(nullable: true),
                    EndPlacePlaceId = table.Column<Guid>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Tours", x => x.TourId);
                    table.ForeignKey(
                        name: "FK_Tours_Places_EndPlacePlaceId",
                        column: x => x.EndPlacePlaceId,
                        principalTable: "Places",
                        principalColumn: "PlaceId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Tours_Places_StartPlacePlaceId",
                        column: x => x.StartPlacePlaceId,
                        principalTable: "Places",
                        principalColumn: "PlaceId",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Places_ParentPlacePlaceId",
                table: "Places",
                column: "ParentPlacePlaceId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Tours_EndPlacePlaceId",
                table: "Tours",
                column: "EndPlacePlaceId");

            migrationBuilder.CreateIndex(
                name: "IX_Tours_StartPlacePlaceId",
                table: "Tours",
                column: "StartPlacePlaceId");
